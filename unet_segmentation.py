...
def download_file(file_path):
    ...
    if file_path=='unet_weights':
        gdd.download_file_from_google_drive(file_id='1Ot_RHbvD_mxb6T8jzOqk2J3uXBiRJtD7',
                                            dest_path='./unet_weights.h5')
...
def run_unet_see_output():
    ...
    # st.write('Model is being loaded into memory and mask images are being predicted on this video - Please get yourself a Cup of Coffee and Sit Back and Relax')
    ...
    # video_file1 = open('masked_video.mp4', 'rb')
